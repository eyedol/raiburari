...
public class LocationUpdatesObservable extends BaseLocationObservable<Location> {
  ...
  @Override public void subscribe(ObservableEmitter<Location> subscriber) {
    baseSubscribe(subscriber);
  }

  @Override protected void onLocationFixed(final ObservableEmitter<? super Location> observer) {
