...
public class TransformAnnotatedFieldTest {
    ...
    @Test
    public void testShouldCheckIfAnnotatedClassIsPrivate() throws ProcessingException {
    ...
    @Test
    public void testShouldCheckIfAnnotatedClassIsProtected() throws ProcessingException {
        expectedException.expect(ProcessingException.class);
        expectedException.expectMessage(
    ...
    @Test
    public void testShouldCheckIfAnnotatedClassIsFinal() throws ProcessingException {
        expectedException.expect(ProcessingException.class);
        expectedException.expectMessage(
                "Field null is declared as final, that is not allowed!");
        given(mTransform.name()).willReturn("name");
    ...
    @Test
    public void testShouldCheckIfAnnotatedClassIsStatic() throws ProcessingException {
        expectedException.expect(ProcessingException.class);
        expectedException.expectMessage(
                "Field null is declared as static. That is not supported!");
        given(mTransform.name()).willReturn("name");
    ...
    @Test
    public void testShouldCheckAnnotatedClassNameIsNull() throws ProcessingException {
        expectedException.expect(ProcessingException.class);
        expectedException.expectMessage(
