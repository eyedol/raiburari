...
package com.addhen.android.raiburari.ui.widget;

import com.addhen.android.raiburari.R;
import com.addhen.android.raiburari.ui.adapter.BaseRecyclerViewAdapter;
import com.addhen.android.raiburari.ui.listener.ObservableScrollState;
import com.addhen.android.raiburari.ui.listener.ObservableScrollViewListener;
import com.addhen.android.raiburari.ui.listener.SwipeToDismissTouchListener;
...
public class BloatedRecyclerView extends FrameLayout {
    ...
    protected void initViews() {
        ...
        mSwipeRefreshLayout = (VerticalSwipeRefreshLayout) view
    ...
    private void setScrollbars() {
        ...
        switch (mScrollbarsStyle) {
            case SCROLLBARS_VERTICAL:
                ...
                View verticalView = inflater
                        .inflate(R.layout.bloated_recyclerview_vertical_scroll, mSwipeRefreshLayout,
                                true);
                recyclerView = (RecyclerView) verticalView
                        .findViewById(R.id.bloated_recycleview_list);
                break;
            case SCROLLBARS_HORIZONTAL:
                mSwipeRefreshLayout.removeView(recyclerView);
                View horizontalView = inflater
                        .inflate(R.layout.bloated_recyclerview_horizontal_scroll,
    ...
    public void setDefaultOnRefreshListener(SwipeRefreshLayout.OnRefreshListener listener) {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(R.color.progress_background,
                R.color.progress_background_dark,
                R.color.progress_done);
